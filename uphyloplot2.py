#!/root/miniconda3/envs/infercnv/bin/python python
# Stefan Kurtenbach
...
#colors = ["#8E8E8E", "#EA9898", "#71C2C6", "#EDB843", "#C270E8", "#6E5BDD", "#7FAD7F", "#8E8E8E", "#EA9898", "#71C2C6", "#EDB843", "#C270E8", "#6E5BDD", "#7FAD7F", "#8E8E8E", "#EA9898", "#71C2C6", "#EDB843", "#C270E8", "#6E5BDD", "#7FAD7F", "#8E8E8E", "#EA9898", "#71C2C6", "#EDB843", "#C270E8", "#6E5BDD", "#7FAD7F"]  # first is grey
    ...
    drawing = svg2rlg("./CNV_files/output.svg")
    renderPM.drawToFile(drawing, "./CNV_files/cnv_tree.png", fmt="PNG")
    image_1 = Image.open("./infercnv.png")
    im_1 = image_1.convert('RGB')
    im_1.save("./CNV_files/infercnv.png")
